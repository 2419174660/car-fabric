...
@WebServlet(name = "supplyMaking", value = "/supplyMaking")
public class supplyMaking extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            //调用的函数名称
            String funcName = "making";
            //调用合约的参数
            String[] arguments = {PurchaseCode,MaterialCode,CostNumber,VinCode,Make,Datetime};
