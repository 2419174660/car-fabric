...
@WebServlet(name = "supplyPurchase", value = "/supplyPurchase")
public class supplyPurchase extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            //调用合约的参数
            String[] arguments = {PurchaseCode,MaterialCode,Description,Owner,PurchaseNumber,Price,Datetime};
