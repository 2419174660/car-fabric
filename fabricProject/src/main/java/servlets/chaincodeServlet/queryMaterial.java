...
@WebServlet(name = "queryMaterial", value = "/queryMaterial")
public class queryMaterial extends HttpServlet {
    @Override
    ...
    * 通过物料ID获取物料详细信息*/
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            //调用的函数名称
            String funcName = "queryMaterial";
            //参数
            String[] arguments = {materialId};
