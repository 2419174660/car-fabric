...
@WebServlet(name = "supplySettlement", value = "/supplySettlement")
public class supplySettlement extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response){
        try{
            ...
            String SettlementDatetime = request.getParameter("SettlementDatetime");
            ...
            //调用的函数名称
            String funcName = "settlement";
            //调用合约的参数
            String[] arguments = {PurchaseCode,MaterialCode,SettlementMethod,SettlementDatetime};
